...
frontend/
  ...
  src/
    ...
    index.css             Tailwind v4 entry: @import "tailwindcss" + @theme design tokens (premium dark/gold) + @layer base body background + @utility gradient-text. No tailwind.config.js.
